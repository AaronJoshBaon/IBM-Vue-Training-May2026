...
<template #meta>
  ...
  <div class="task-card">
    ...
    <div class="task-actions">
      ...
      <button @click="emit('complete', props.task.id)" class="btn-complete">{{props.task.done ? "Undo" : "Complete"}}</button>
      <!-- TODO 8: Add Delete button — emits 'delete' with task.id -->
      <button @click="emit('delete', props.task.id)" class="btn-delete">Delete</button>
    </div>
  </div>
</template>
