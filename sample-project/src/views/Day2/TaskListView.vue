...
const tasks = ref([
  {id: 1, name: "Task1", done: false, dueDate: new Date("2026-06-20")},
  {id: 2, name: "Task2", done: false, dueDate: new Date("2026-06-21")},
  {id: 3, name: "Task3", done: false, dueDate: new Date("2026-06-22")},
])
