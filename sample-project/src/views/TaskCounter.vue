...
<template>
  <div class="app">
    ...
    <div class="filters">
      ...
      <button @click="selectedFilter = 'done'" :class="{ active: selectedFilter === 'done' }">Done</button>
      <button @click="selectedFilter = 'pending'" :class="{ active: selectedFilter === 'pending' }">Pending</button>
    </div>
